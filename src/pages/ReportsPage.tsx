    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Period selector */}
          <div className="flex items-center gap-1 p-0.5 rounded-xl bg-elevated-1 border border-border">
        ...
        {[
          ...
          <div key={kpi.label} className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${kpi.accent} backdrop-blur-xl border border-border p-5`}>
            <div className="flex items-start justify-between">
              ...
              <div className="p-2 rounded-xl bg-elevated-2">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <Card>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            <div className="text-center p-3 rounded-xl bg-elevated-1 border border-border">
            ...
            <div className="space-y-3">
              {segmentData.map((seg) => (
                <div key={seg.name} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-5 rounded-lg bg-elevated-2 overflow-hidden relative">
