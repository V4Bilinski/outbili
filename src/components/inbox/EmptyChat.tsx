  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-[var(--wa-bg)] wa-wallpaper">
      <div className="text-center max-w-sm px-6">
        ...
        <h3 className="text-xl font-medium text-[var(--wa-text)] mb-2">OUTBILI Inbox</h3>
        <p className="text-[14px] text-[var(--wa-text-secondary)] leading-relaxed">
          Selecione uma conversa para visualizar as mensagens e interagir com seus contatos via WhatsApp.
        </p>
      </div>
    </div>
  )
