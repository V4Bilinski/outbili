  ...
  return (
    <div
      ...
      className={cn(
        ...
        accentStyles[accent],
        hover && 'transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-1 hover:border-border-strong hover:shadow-xl hover:shadow-black/30 cursor-pointer',
        accent === 'hot' && hover && 'hover:shadow-[0_0_20px_rgba(255,59,48,0.15),0_8px_30px_rgba(0,0,0,0.3)]',
